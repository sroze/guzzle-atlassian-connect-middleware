...
class JwtTokenTest extends TestCase
{
    ...
    public function sign_allProperties_Success()
    {
        ...
        $this->assertEquals(
            'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..VfvMt5u4yFNdF2j_MK1EB1A663v9NHuDxylnbee0k1c',
            $token->sign()
        );
